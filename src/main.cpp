...
uint256 hashGenesisBlock("0x1bdf03d8e8a35c12127e412c6546b826808961dd374c7d0bb886b8cefc88fb43");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(521093680); // Americoin: starting difficulty is 1 / 2^12
...
{
    int64 nSubsidy = 100000000;
    if (nHeight == 1)  
		return 5000000000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 250000); // Americoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 15; // 
...
{
    // Americoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa4d3317b8e78aa0201e8dd30829fe73eea97180913e22c7afb47e13477102425");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Not walletbuilders";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0cc246276653b93a17132926449f927636476008b6c18e44495ca7c635e5c85fef8b3f149ab4947ca7a1ca597708d70a6331c1d69b6a3122c4643b15c36db7585d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1490000629;
        block.nBits    = 521093680;
        block.nNonce   = 2879387488;

        if (fTestNet)
        {
            block.nTime    = 1490000629;
            block.nNonce   = 2125601517;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9b216df9fca1fa3726013c62a696f066ba8b129969f912126de295c25a2ea148"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Americoin: increase each by adding 2 to bitcoin's value.
